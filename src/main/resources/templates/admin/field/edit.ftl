			...
			<div class="content-wrapper">
				...
				<section class="content-header">
			        ...
			        <small style="color:#737373;">
			        	...
			        	<i class="fa fa-angle-double-right"></i> 修改题库
			        </small>
				</section>
				<!-- /.content-header -->
				<section class="content">
					<div class="row">
						<form action="${path}/admin/field/edit" id="form-field-add" method="POST" class="col-md-12">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label for="name" class="col-md-3 control-label"><small class="text-red">*</small> 题库名（必填）</label>
													<div class="col-md-8">
														<input type="hidden" name="id" value="${field.id}"/>
														<input required="required" type="text" class="form-control" name="name" id="name" value="${(field.name)!}" placeholder="请输入题库名" />
													</div>
												</div>
												<div class="form-group">
													<label for="memo" class="col-md-3 control-label"><small class="text-red">*</small> 描述（必填）</label>
													<div class="col-md-8">
														<input required="required" type="text" class="form-control" name="memo" id="memo" value="${(field.memo)!}" placeholder="请输入描述信息" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
													...
													<div class="col-md-8">
														<select id="state" class="form-control" name="status">
															<#list status as state>
																<#if field.status?? && field.status = state.value()>
