			...
			<div class="content-wrapper">
				...
				<section class="content-header">
			        ...
			        <small style="color:#737373;">
			        	...
			        	<i class="fa fa-angle-double-right"></i> 修改用户
			        </small>
				</section>
				<!-- /.content-header -->
				<section class="content">
					<div class="row">
						<form action="${path}/admin/user/edit" id="form-user-add" method="POST" class="col-md-12">
											...
											<div class="col-md-12 border-left">
												<div class="form-group">
													...
													<div class="col-md-8">
														...
														<input type="text" class="form-control" name="username" id="username" required="required" autofocus="autofocus"  value="${(user.username)!}" placeholder="登录名"/>
													</div>
												</div>
												<div class="form-group">
													<label for="realname" class="col-sm-3 control-label"><small class="text-red">*</small> 真实名（必填）</label>
													<div class="col-sm-8">
														<input type="text" class="form-control" name="realname" id="realname"  value="${(user.realname)!}" required="required" placeholder="请输入真实姓名"/>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-8">
														<select id="state" class="form-control" name="status">
															<#list status as state>
																<#if user.status?? && user.status = state.value()>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														<select id="typeId" class="form-control" name="typeId">
															<#list roles as role>
																<#if user.typeId?? && user.typeId = role.parseInt()>
																	<option value="${role.parseInt()}" selected="selected">${role}</option>
																<#else>
