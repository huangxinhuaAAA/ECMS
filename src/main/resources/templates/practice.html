...
<html xmlns:th="http://www.thymeleaf.org">
	...
	<body>
			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav">
			        ...
			        <li class="active"><a href="#"><i class="fa fa-edit"></i>试题练习</a></li>
		...
		<div class="icon_content_holder center_content text-center" style="margin-top: 100px; min-height: 325px;">
			<div class="container">
